...
JBOSS_EJB_EXTRA_EXCLUDING_WITH_STACKTRACES = ["Activation failure: javax.ejb.EJBException: Could not activate; failed to restore state", " DEBUG ", ", callbackMethod=MerchantApiBean.processResponse, errorCode=EVENT_CALLBACK_ERROR, nextAttempt=", "couldn't get loginUserSF by handle: Could not activate;", "ORA-00001: unique constraint (OFFNET.XCHG_RATE_UNIQ) violated", "java.rmi.NoSuchObjectException: Could not activate; failed to restore state"]
JBOSS_SERVLET_EXTRA_EXCLUDING_WITH_STACKTRACES = ["Illegal args exception validating", "couldn't get loginUserSF by handle: Could not activate;", "ORA-00001: unique constraint (OFFNET.XCHG_RATE_UNIQ) violated", "java.rmi.NoSuchObjectException: Could not activate; failed to restore state"]
